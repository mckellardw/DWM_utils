...
GENES="/workdir/dwm269/genomes/mm39_all/GENCODE_M32/gencode.vM32.annotation.gtf"

OUTDIR="/workdir/dwm269/genomes/mm39_all/STAR_GRCm39_GENCODEM32_rRNA"
FASTA_rRNA=${OUTDIR}/GRCm39_GENCODEM32_rRNA.fa
GENES_rRNA=${OUTDIR}/GRCm39_GENCODEM32_rRNA.gtf
