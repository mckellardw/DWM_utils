...
## Description: This script takes in a .fasta from GtRNAb and generates a .gtf, which can be used to build a reference for alignment of RNAseq data
#####################################

# usage:
#      python build_GtRNAdb.py GtRNAdb.fasta output_name.gtf
